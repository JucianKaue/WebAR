// import * as THREE from 'three'; // Three.js module
// import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls'; // Module to control the camera with mouse
...
//     45,                                         // Abertura da camera (entre 40° e 80)
//     window.innerWidth / window.innerHeight,     // Tamanho da imagem da camera
//     0.1,                                        // Minimo de distância da camera
//     1000                                        // Máximo de distância da camera
// );
...
// camera.position.set(-10, 30, 30); // Set the position of the camera (x, y, z)
